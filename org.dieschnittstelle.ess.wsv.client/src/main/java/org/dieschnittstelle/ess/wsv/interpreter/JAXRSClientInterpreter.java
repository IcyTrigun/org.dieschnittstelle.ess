...
public class JAXRSClientInterpreter implements InvocationHandler {
    ...
    public JAXRSClientInterpreter(Class serviceInterface,String baseurl) {
        ...
        //DONE // TODO: implement the constructor!
    ...
    public Object invoke(Object proxy, Method meth, Object[] args)
        ...
        //DONE // TODO check whether we handle the toString method and give some appropriate return value
        ...
        //DONE // TODO: create the url using baseurl and commonpath (further segments may be added if the method has an own @Path annotation)
        String url = baseurl + commonPath + (meth.isAnnotationPresent(Path.class) ? meth.getAnnotation(Path.class).value() : "");

        //DONE // TODO: check whether we have a path annotation and append the url (path params will be handled when looking at the method arguments)
        ...
        //DONE //TODO: check which of the http method annotation is present and instantiate request accordingly passing the url
        ...
        //DONE // TODO: add a header on the request declaring that we accept json (for header names, you can use the constants declared in javax.ws.rs.core.HttpHeaders, for content types use the constants from javax.ws.rs.core.MediaType;)
        ...
        if (bodyValue != null) {
            ...
            //DONE // TODO: use a ByteArrayOutputStream for writing json
            ByteArrayOutputStream bos = new ByteArrayOutputStream();

            //DONE // TODO: write the object to the stream using the
            jsonSerialiser.writeObject(bodyValue,bos);

            //DONE // TODO: create an ByteArrayEntity from the stream's
            bae = new ByteArrayEntity(bos.toByteArray());

            //DONE // TODO: set the entity on the request, which must be cast to HttpEntityEnclosingRequest
            ((HttpEntityEnclosingRequest)request).setEntity(bae);

            //DONE // TODO: and add a content type header for the request
        ...
        if (response.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
            ...
            // DONE // TODO: convert the resonse body to a java object of an appropriate type considering the return type of the method as returned by getGenericReturnType() and set the object as value of returnValue
